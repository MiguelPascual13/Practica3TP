...
public class ParserComandos {
	...
	/**
	 * Encargada de crear un string con todos los textos de ayuda de cada uno de los comandos. 
	 * @return 
	 * Devuelve un string con los textos de ayuda de cada uno de los comandos. 
	 */
	 ...
	 * @return
	 * Devuelve el comando correspondiente que coincida con la cadena de caracteres pasada por parametro. 
	 * @throws ErrorComando
	 * Lanza una excepcion de error comando si uno de los comandos que se desea comprobar presenta un error de ecritura o de formato. 
	 * @throws ComandoNoExistente
	 * Lanza una excepcion de comando no existente si el comando que desea parsear no existe. 
	 */
